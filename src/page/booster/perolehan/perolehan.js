...
const PerolehanBoosting = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${backendUrl}/api/boosting/add`, { // Ganti endpoint sesuai kebutuhan
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
        body: JSON.stringify({ NIP, nominal, ket, nama_game: namaGame }), // Mengirim nama_game
      });
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-3">
                    ...
                    <textarea
                      ...
                      // Menghapus atribut required agar tidak wajib diisi
                    />
                  </div>
                  <div className="mb-3">
